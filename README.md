...
The three segments (SOHO / Protons / Neutrons) are vertically stacked using OpenCV + Matplotlib (and Pillow). This project is an evolved fork of [SolarActivid](https://github.com/marcroussel/SolarActivid) with GitHub Actions automation.
...
* Vertical assembly into a single MP4 (codec `mp4v`).
* Localized weekly naming: `Week n°X (DDMMYYYY-DDMMYYYY).mp4`.
* Automatic purge of videos older than 14 days (daily + weekly) and configurable weekly retention.
 
## Recent Additions / Details
